<template>
  <b-card p-5>
    <b-card-header class="d-flex justify-content-between align-items-center">
      <b-card-title>Báo cáo lịch sử kinh doanh năm</b-card-title>
      ...
      <div>
        ...
        >
          <template slot="table-row" slot-scope="props">
            <!-- Column: Name -->
            <div v-if="props.column.field === 'detail'" class="text-nowrap">
              <a class="text-nowrap">Chi tiết</a>
            </div>
          </template>
          <!-- pagination -->
